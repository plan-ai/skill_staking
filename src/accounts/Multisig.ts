...
export class Multisig implements MultisigArgs {
  private constructor(
    ...
    readonly owners: web3.PublicKey[],
    readonly threshold: beet.bignum
  ) {}
  ...
  static fromArgs(args: MultisigArgs) {
    return new Multisig(args.bump, args.owners, args.threshold)
  }
  ...
  pretty() {
    return {
      ...
      owners: this.owners,
      threshold: (() => {
        const x = <{ toNumber: () => number }>this.threshold
